...
const specialMovesObj = {
  ...
  'momentum': {'Banton Pass': true, 'U-turn': true, 'U-Turn': true, 'u-turn': true, 'U Turn': true, 'Chilly Reception': true, 'Flip Turn': true, 'Momento': true, 'Parting Shot': true, 'Teleport': true, 'Shed Tail': true, 'Volt Routes': true},
  'item removal': {'Knock Off': true, 'Trick': true, 'Routeseroo': true},
